    ...
    <section class="start">
        <div class="container">
            <div class="d-flex justify-content-start">
                ...
                <button href="{{url ('home') }}" type="button" class="btn btn-warning" id="btn">Get Started</button>
            </div>
        ...
        <div class="bg">
            <img src="{{asset('assets/images/intro.png')}}" alt="intro-background" id="bg">
            <img src="{{asset('assets/images/intro-mobile.png')}}" alt="intro-background" id="mobile">
        </div>
    </section>
