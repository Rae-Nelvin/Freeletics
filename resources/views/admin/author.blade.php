    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('admin.dashboard') }}">
                        <h2 id="nav-title">FREELETICS SURABAYA</h2>
                    </a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('admin.dashboard') }}" class="brand-link">
                <img src="{{ asset('images/logo.png') }}" alt="Freeletics Logo" class="brand-image elevation-5"
                    style="opacity: .8">
                <br>
            </a>
        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"
                                        style="color: white; font-size: 20px;font-weight: bold;font-family: Nunito;">Home</a>
                                </li>
                                <li class="breadcrumb-item active"
                                    style="font-size: 20px;color: #edc124;font-weight: bold;font-family: Nunito;">Author
                                </li>
                                <br>
                            </ol>
                        </div><!-- /.col -->
          ...
          <div class="card-body bg-custom-1 rounded">
            <div class="row" style="margin-left: 10px;margin-right: 10px;">
                <div class="col-sm-12">
                    <h1 class="m-0 h1-title" style="font-size: 30px;font-family: Nunito;color: white;">About Us</h1>
                    <!-- End of Button -->
                    <!-- Description Table -->
                    <table style="margin-top: 10px">
                        ...
                        <tr class="table100-head">
                            ...
                            @foreach ($caption as $captions)
                                ...
                                <td class="column6-1"><a class="button touch edit edit-btn mb-2" href="{{ route('admin.upload_caption',1) }}"></a>
                                </tr>
                            @endforeach
                            </tbody>
                            </table>
            ...
            <div class="card-body bg-custom-1 rounded mt-5">
                <div class="row" style="margin-left: 10px;margin-right: 10px;">
                    <div class="col-sm-10">
                    <h1 class="m-0 h1-title" style="font-size: 30px;font-family: Nunito;color:white;">Author</h1>
                    </div>
                    <div class="col-sm-2"><a class="button primary new addnew-btn" href="{{ route('admin.upload_photos',1) }}" style="font-family: inherit; font-weight: bold;font-family: Nunito;">Add New</a></div>
                    <!-- End of Button -->
                    <!-- Table -->
                    <table>
                        <thead>
