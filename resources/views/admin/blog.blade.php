  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      @endif
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 h1-title" style="font-size: 60px;font-family: Nunito;">Blog</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active" style="font-size: 20px;color: #edc124;font-weight: bold;font-family: Nunito;">Blog</li>
              <br>
            </ol>
          </div><!-- /.col -->
          ...
          <div class="card-body bg-custom-1 rounded mt-5">
            <div class="row" style="margin-left: 10px;margin-right: 10px;">
              <div class="col-sm-10">
                <h1 class="m-0 h1-title" style="font-size: 30px;font-family: Nunito;color:white;">Content</h1>
              </div>
              <div class="col-sm-2"><a class="button primary new addnew-btn" href="{{ route('admin.upload_photos',6) }}" style="font-family: inherit; font-weight: bold;font-family: Nunito;">Add New</a></div>
                <!-- End of Button -->
                <!-- Table -->
                <table>
                  <thead>
