  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      @endif
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 h1-title" style="font-size: 60px;font-family: Nunito;">12 Weeks</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active" style="font-size: 20px;color: #edc124;font-weight: bold;font-family: Nunito;">12 Weeks</li>
              <br>
            </ol>
          </div><!-- /.col -->
          </div>
              ...
              <table style="margin-top: 10px">
                        ...
                        <tr class="table100-head">
                            ...
                            @foreach ($caption as $captions)
                                ...
                                <td class="column6-1"><a class="button touch edit edit-btn mb-2" href="{{ route('admin.upload_caption',4) }}"></a>
                                </tr>
                            @endforeach
                            </tbody>
                            </table>
          ...
          <div class="card-body bg-custom-1 rounded mt-5">
            <div class="row" style="margin-left: 10px;margin-right: 10px;">
              ...
              <div class="col-sm-2"><a class="button primary new addnew-btn" href="{{ route('admin.upload_photos',4) }}" style="font-family: inherit; font-weight: bold;font-family: Nunito;">Add New</a></div>
              <!-- End of Button -->
              <!-- Table -->
              <table>
                <thead>
