        ...
        <div class="row mb-2">
          ...
          <div class="card-body bg-custom-1 rounded mt-5">
            <div class="row">
              ...
              <div class="col-sm-2"><a class="button primary new addnew-btn" href="{{ route('admin.upload_photos',5) }}" style="font-family: inherit; font-weight: bold;font-family: Nunito;">Add New</a></div>
                <!-- End of Button -->
                <!-- Table -->
                <table>
                  <thead>
