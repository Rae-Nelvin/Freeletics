      ...
      @if(Session::get('Successful'))
        ...
        <div class="row mb-2">
          ...
          <div class="row" style="margin-left: 10px;margin-right: 10px;">
              ...
              <div class="col-sm-3"><a class="button primary new addnew-btn" href="{{ route('admin.upload_caption',3) }}" style="font-family: inherit; font-weight: bold;font-family: Nunito;">Add New</a></div>
              <!-- End of Button -->
              <!-- Table -->
              <table>
                <thead>
        ...
        <div class="row" style="margin-top: 80px;margin-left: 10px;margin-right: 10px;">
          ...
          <div class="col-sm-3"><a class="button primary new addnew-btn" href="{{ route('admin.upload_photos',3) }}" style="font-family: inherit; font-weight: bold;font-family: Nunito;">Add New</a></div>
          <!-- End of Button -->
          <!-- Table -->
          <table>
						<thead>
