  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      @if(Session::get('Successful'))
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 h1-title" style="font-size: 40px;">Fun Run</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}" style="color: white; font-size: 20px">Home</a></li>
              <li class="breadcrumb-item active" style="font-size: 20px;color: #edc124;">Fun Run</li>
              <br>
            </ol>
          </div><!-- /.col -->
          <!-- Add New Button -->
          ...
          <div class="col-sm-3"><a class="button primary new addnew-btn" href="{{ route('admin.upload_photos',3) }}" style="font-family: inherit; font-weight: bold;">Add New</a></div>
          <!-- End of Button -->
          <!-- Table -->
