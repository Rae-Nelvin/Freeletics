  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      @endif
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 h1-title" style="font-size: 60px;font-family: Nunito;">Fun Run</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active" style="font-size: 20px;color: #edc124;font-weight: bold;font-family: Nunito;">Fun Run</li>
              <br>
            </ol>
          </div><!-- /.col -->
          </div>
