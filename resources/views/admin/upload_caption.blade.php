        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col">
                            <h1 class="m-0 h4-title" style="font-size: 40px;font-family: Nunito;">Add New</h1>
                        </div><!-- /.col -->
                        <div class="col-lg-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"
                                        style="color: white; font-size: 20px">Home</a></li>
                                <li class="breadcrumb-item active"
                                    style="font-size: 20px;color: #edc124;font-family: Nunito;">Add New</li>
                                <br>
                            </ol>
                        </div><!-- /.col -->
                        <div style="margin-top: 40px;">
                            <form action="{{ route('admin.uploadcaption') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="EventForm" class="title-edit"
                                        style="font-family: Nunito;font-size: 30px;"><?php echo"<input type='hidden' name='event' value=$event>Event :  ";  echo $event ?></label>
                                </div>
                                <div class="form-group">
                                    <label for="EventForm" class="title-edit" style="font-family: Nunito;">Masukkan
                                        Caption : </label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="caption"
                                        size="60">
                                </div>
                                <input type="submit" class="button btn-success"
                                    style="font-family: Nunito;font-weight: bold;" /></button>
                            </form>
                        </div>
                    </div>
                </div><!-- /.row -->
