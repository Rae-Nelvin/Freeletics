...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Freeletics/assets/css/style.css">
    ...
    <section class="start">
        <div class="container">
            <div class="d-flex justify-content-start">
                <div class="logo">
                    <img src="../Freeletics/assets/images/logo.png" alt="logo">
                </div>
                <div class="caption">
        ...
        <div class="bg">
            <img src="../Freeletics/assets/images/intro.png" alt="intro-background" id="bg">
            <img src="../Freeletics/assets/images/intro-mobile.png" alt="intro-background" id="mobile">
        </div>
    </section>
